...
use crate::symmetry::symmetry_symbols::{
    deduce_mirror_parity, MirrorParity, MullikenIrcorepSymbol, MullikenIrrepSymbol,
    SymmetryClassSymbol,
};
...
#[test]
fn test_deduce_mirror_parity_d6h() {
    ...
    let rep_b1g_ps = deduce_mirror_parity(&group, &rep_b1g);
    ...
    let rep_b2g_ps = deduce_mirror_parity(&group, &rep_b2g);
    ...
    let rep_e1g_ps = deduce_mirror_parity(&group, &rep_e1g);
    ...
    let rep_e2g_ps = deduce_mirror_parity(&group, &rep_e2g);
    ...
    let rep_e1ge2g_ps = deduce_mirror_parity(&group, &rep_e1ge2g);
...
#[test]
fn test_deduce_mirror_parity_d5h() {
    ...
    let rep_e1d_ps = deduce_mirror_parity(&group, &rep_e1d);
