...
fn test_chartab_spherical_c60_ih() {
    ...
    let expected_irreps = vec![
        ...
        MullikenIrrepSymbol::new("||T|_(1g)|").unwrap(),
        MullikenIrrepSymbol::new("||T|_(2g)|").unwrap(),
        MullikenIrrepSymbol::new("||F|_(g)|").unwrap(),
        MullikenIrrepSymbol::new("||H|_(g)|").unwrap(),
        MullikenIrrepSymbol::new("||A|_(u)|").unwrap(),
        MullikenIrrepSymbol::new("||T|_(1u)|").unwrap(),
        MullikenIrrepSymbol::new("||T|_(2u)|").unwrap(),
        MullikenIrrepSymbol::new("||F|_(u)|").unwrap(),
...
*********/
#[test]
fn test_chartab_spherical_c60_ih_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/c60.xyz");
    let thresh = 1e-5;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
        ...
        MullikenIrrepSymbol::new("||F~|_(g)|").unwrap(),
        MullikenIrrepSymbol::new("||I~|_(g)|").unwrap(),
        MullikenIrrepSymbol::new("||E~|_(1u)|").unwrap(),
        MullikenIrrepSymbol::new("||E~|_(2u)|").unwrap(),
        MullikenIrrepSymbol::new("||F~|_(u)|").unwrap(),
        MullikenIrrepSymbol::new("||I~|_(u)|").unwrap(),
    ];
    let c5 = SymmetryClassSymbol::<SymmetryOperation>::new("12||C5(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        (
            (&expected_irreps[0], &c5),
            Character::new(&[(UnityRoot::new(0, 10), 1)]),
    ...
    test_chartab_ordinary_double_group(&mol, thresh, "Ih*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_spherical_c60_grey_ih_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/c60.xyz");
    let thresh = 1e-5;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
        ...
        MullikenIrrepSymbol::new("|_(a)|F~|_(g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|I~|_(g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|E~|_(1u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|E~|_(2u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|F~|_(u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|I~|_(u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|E~|_(1g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|E~|_(2g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|F~|_(g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|I~|_(g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|E~|_(1u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|E~|_(2u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|F~|_(u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|I~|_(u)|").unwrap(),
    ];
    let tc5 = SymmetryClassSymbol::<SymmetryOperation>::new("12||θ·C5(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        (
            (&expected_irreps[0], &tc5),
            Character::new(&[(UnityRoot::new(0, 10), 1)]),
        ...
        (
            (&expected_irreps[32], &tc5),
            Character::new(&[(UnityRoot::new(13, 20), 1), (UnityRoot::new(17, 20), 1)]),
        ),
        (
            (&expected_irreps[33], &tc5),
            Character::new(&[(UnityRoot::new(1, 20), 1), (UnityRoot::new(9, 20), 1)]),
        ),
        (
            (&expected_irreps[34], &tc5),
            Character::new(&[(UnityRoot::new(15, 20), 1)]),
        ),
        (
            (&expected_irreps[35], &tc5),
            Character::new(&[(UnityRoot::new(5, 20), 1)]),
        ),
    ]);
...
#[test]
fn test_chartab_spherical_ch4_td_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/ch4.xyz");
    let thresh = 1e-6;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
        ...
        MullikenIrrepSymbol::new("||F~||").unwrap(),
    ];
    let c3 = SymmetryClassSymbol::<SymmetryOperation>::new("8||C3(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        (
            (&expected_irreps[0], &c3),
            Character::new(&[(UnityRoot::new(0, 3), 1)]),
    ...
    test_chartab_ordinary_double_group(&mol, thresh, "Td*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_spherical_ch4_grey_td_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/ch4.xyz");
    let thresh = 1e-6;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
        ...
        MullikenIrrepSymbol::new("|_(a)|F~||").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|E~|_(1)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|E~|_(2)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|F~||").unwrap(),
    ];
    let tc3 = SymmetryClassSymbol::<SymmetryOperation>::new("8||θ·C3(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        (
            (&expected_irreps[0], &tc3),
            Character::new(&[(UnityRoot::new(0, 3), 1)]),
...
#[test]
fn test_chartab_spherical_vh2o6_th_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/vh2o6.xyz");
    let thresh = 1e-6;
    let mol = Molecule::from_xyz(&path, thresh);
    ...
    let c3 = SymmetryClassSymbol::<SymmetryOperation>::new("4||C3(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        (
            (&expected_irreps[0], &c3),
            Character::new(&[(UnityRoot::new(0, 3), 1)]),
        ...
        (
            (&expected_irreps[12], &c3),
            Character::new(&[(UnityRoot::new(0, 3), 1)]),
        ),
        (
            (&expected_irreps[13], &c3),
            Character::new(&[(UnityRoot::new(2, 3), 1)]),
        ),
    ]);
    test_chartab_ordinary_double_group(&mol, thresh, "Th*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_spherical_vh2o6_grey_th_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/vh2o6.xyz");
    let thresh = 1e-6;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
    ...
    let tc3 = SymmetryClassSymbol::<SymmetryOperation>::new("4||θ·C3(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        (
            (&expected_irreps[0], &tc3),
            Character::new(&[(UnityRoot::new(0, 3), 1)]),
        ...
        (
            (&expected_irreps[16], &tc3),
            Character::new(&[(UnityRoot::new(5, 12), 1), (UnityRoot::new(9, 12), 1)]),
        ),
        (
            (&expected_irreps[17], &tc3),
        ...
        (
            (&expected_irreps[18], &tc3),
            Character::new(&[(UnityRoot::new(1, 12), 1), (UnityRoot::new(9, 12), 1)]),
        ),
        (
            (&expected_irreps[19], &tc3),
            Character::new(&[(UnityRoot::new(5, 12), 1), (UnityRoot::new(9, 12), 1)]),
        ...
        (
            ...
            Character::new(&[(UnityRoot::new(3, 12), 1), (UnityRoot::new(11, 12), 1)]),
        ),
        (
        ...
        (
            ...
            Character::new(&[(UnityRoot::new(3, 12), 1), (UnityRoot::new(7, 12), 1)]),
        ),
        (
...
#[test]
fn test_chartab_spherical_vf6_oh_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/vf6.xyz");
    let thresh = 1e-12;
    let mol = Molecule::from_xyz(&path, thresh);
    ...
    let expected_chars = HashMap::from([
        ...
        (
            (&expected_irreps[14], &c3),
            Character::new(&[(UnityRoot::new(0, 3), 1)]),
        ),
        (
            (&expected_irreps[15], &c3),
            Character::new(&[(UnityRoot::new(1, 3), 1), (UnityRoot::new(2, 3), 1)]),
        ),
    ]);
    test_chartab_ordinary_double_group(&mol, thresh, "Oh*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_spherical_vf6_grey_oh_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/vf6.xyz");
    let thresh = 1e-12;
    let mol = Molecule::from_xyz(&path, thresh);
...
#[test]
fn test_chartab_symmetric_ch4_magnetic_field_c3_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/ch4.xyz");
    let thresh = 1e-6;
    let mut mol = Molecule::from_xyz(&path, thresh);
    ...
    test_chartab_ordinary_double_group(&mol, thresh, "C3*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_symmetric_65coronane_electric_field_grey_c3_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/coronane65.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
    ...
    let tc3 = SymmetryClassSymbol::<SymmetryOperation>::new("1||θ·C3(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        (
            (&expected_irreps[0], &tc3),
            Character::new(&[(UnityRoot::new(0, 3), 1)]),
...
#[test]
fn test_chartab_symmetric_h8_twisted_electric_field_c4_double() {
    let thresh = 1e-7;
    let mut mol = template_molecules::gen_twisted_h8(0.1);
    mol.set_electric_field(Some(Vector3::new(0.0, 0.0, -0.1)));
    let expected_irreps = vec![
    ...
    let c4 = SymmetryClassSymbol::<SymmetryOperation>::new("1||C4(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        (
            (&expected_irreps[0], &c4),
            Character::new(&[(UnityRoot::new(0, 4), 1)]),
    ...
    test_chartab_ordinary_double_group(&mol, thresh, "C4*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_symmetric_h8_twisted_electric_field_grey_c4_double() {
    let thresh = 1e-7;
    let mut mol = template_molecules::gen_twisted_h8(0.1);
    mol.set_electric_field(Some(Vector3::new(0.0, 0.0, -0.1)));
    let expected_irreps = vec![
    ...
    let tc4 = SymmetryClassSymbol::<SymmetryOperation>::new("1||θ·C4(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        (
            (&expected_irreps[0], &tc4),
            Character::new(&[(UnityRoot::new(0, 4), 1)]),
...
***/
#[test]
fn test_chartab_symmetric_nh3_c3v_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/nh3.xyz");
    let thresh = 1e-6;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
...
#[test]
fn test_chartab_symmetric_antiprism_pb10_electric_field_c4v_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/pb10.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_electric_field(Some(Vector3::new(0.0, 0.0, 1.0)));
...
#[test]
fn test_chartab_symmetric_antiprism_pb10_electric_field_grey_c4v_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/pb10.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_electric_field(Some(Vector3::new(0.0, 0.0, 1.0)));
...
#[test]
fn test_chartab_symmetric_cpnico_c5v_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/cpnico.xyz");
    let thresh = 1e-6;
    let mol = Molecule::from_xyz(&path, thresh);
...
#[test]
fn test_chartab_symmetric_c60_electric_field_grey_c5v_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/c60.xyz");
    let thresh = 1e-6;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_electric_field(Some(Vector3::new(0.0, 0.0, 1.0)));
...
#[test]
fn test_chartab_symmetric_benzene_electric_field_c6v_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/benzene.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
...
#[test]
fn test_chartab_symmetric_au26_electric_field_grey_c6v_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/au26.xyz");
    let thresh = 1e-6;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_electric_field(Some(Vector3::new(0.0, 0.0, 1.0)));
...
***/
#[test]
fn test_chartab_symmetric_bf3_magnetic_field_c3h_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/bf3.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_magnetic_field(Some(Vector3::new(0.0, 0.0, 1.0)));
...
#[test]
fn test_chartab_symmetric_bf3_magnetic_field_bw_d3h_c3h_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/bf3.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_magnetic_field(Some(Vector3::new(0.0, 0.0, 1.0)));
...
#[test]
fn test_chartab_symmetric_xef4_magnetic_field_c4h_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/xef4.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_magnetic_field(Some(Vector3::new(0.0, 0.0, -1.0)));
    ...
    let expected_chars = HashMap::from([
        ...
        (
            (&expected_irreps[14], &c4),
            Character::new(&[(UnityRoot::new(5, 8), 1)]),
        ),
        (
            (&expected_irreps[15], &c4),
            Character::new(&[(UnityRoot::new(7, 8), 1)]),
        ),
    ]);
    test_chartab_ordinary_double_group(
...
#[test]
fn test_chartab_symmetric_h8_magnetic_field_bw_d4h_c4h_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/h8.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, 1e-7);
...
#[test]
fn test_chartab_symmetric_eclipsed_ferrocene_magnetic_field_c5h_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/eclipsed_ferrocene.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_magnetic_field(Some(Vector3::new(0.0, 0.0, -1.0)));
...
#[test]
fn test_chartab_symmetric_eclipsed_ferrocene_magnetic_field_bw_d5h_c5h_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/eclipsed_ferrocene.xyz");
    let thresh = 1e-6;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_magnetic_field(Some(Vector3::new(0.0, 0.0, -1.0)));
...
#[test]
fn test_chartab_symmetric_benzene_magnetic_field_c6h_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/benzene.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
    ...
    let expected_irreps = vec![
        ...
        MullikenIrrepSymbol::new("|_(a)|Γ~|_(1g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|Γ~|_(2g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|Γ~|_(3g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|Γ~|_(3g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|Γ~|_(2g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|Γ~|_(1g)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|Γ~|_(1u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|Γ~|_(2u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(a)|Γ~|_(3u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|Γ~|_(3u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|Γ~|_(2u)|").unwrap(),
        MullikenIrrepSymbol::new("|_(b)|Γ~|_(1u)|").unwrap(),
    ];
    let c6 = SymmetryClassSymbol::<SymmetryOperation>::new("1||C6(Σ)||", None).unwrap();
    let expected_chars = HashMap::from([
        ...
        (
            (&expected_irreps[18], &c6),
            Character::new(&[(UnityRoot::new(1, 12), 1)]),
        ),
        (
            (&expected_irreps[19], &c6),
            Character::new(&[(UnityRoot::new(3, 12), 1)]),
        ),
        (
            (&expected_irreps[20], &c6),
            Character::new(&[(UnityRoot::new(5, 12), 1)]),
        ),
        (
            (&expected_irreps[21], &c6),
            Character::new(&[(UnityRoot::new(7, 12), 1)]),
        ),
        (
            (&expected_irreps[22], &c6),
            Character::new(&[(UnityRoot::new(9, 12), 1)]),
        ),
        (
            (&expected_irreps[23], &c6),
            Character::new(&[(UnityRoot::new(11, 12), 1)]),
        ),
    ]);
    test_chartab_ordinary_double_group(
...
#[test]
fn test_chartab_symmetric_benzene_magnetic_field_bw_d6h_c6h_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/benzene.xyz");
    let thresh = 1e-7;
    let mut mol = Molecule::from_xyz(&path, thresh);
    mol.set_magnetic_field(Some(Vector3::new(1.0, 0.0, 0.0)));
...
***/
#[test]
fn test_chartab_symmetric_triphenyl_radical_d3_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/triphenylradical.xyz");
    let thresh = 1e-7;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
    ...
    test_chartab_ordinary_double_group(&mol, thresh, "D3*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_symmetric_triphenyl_radical_grey_d3_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/triphenylradical.xyz");
    let thresh = 1e-7;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
...
#[test]
fn test_chartab_symmetric_h8_twisted_d4_double() {
    let thresh = 1e-7;
    let mol = template_molecules::gen_twisted_h8(0.1);
    let expected_irreps = vec![
        MullikenIrrepSymbol::new("||A|_(1)|").unwrap(),
    ...
    test_chartab_ordinary_double_group(&mol, thresh, "D4*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_symmetric_h8_twisted_grey_d4_double() {
    let thresh = 1e-7;
    let mol = template_molecules::gen_twisted_h8(0.1);
    let expected_irreps = vec![
        MullikenIrrepSymbol::new("|^(+)|A|_(1)|").unwrap(),
...
#[test]
fn test_chartab_symmetric_c5ph5_d5_double() {
    // env_logger::init();
    let path: String = format!("{}{}", ROOT, "/tests/xyz/c5ph5.xyz");
    let thresh = 1e-7;
    let mol = Molecule::from_xyz(&path, thresh);
    ...
    test_chartab_ordinary_double_group(&mol, thresh, "D5*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_symmetric_c5ph5_grey_d5_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/c5ph5.xyz");
    let thresh = 1e-7;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
...
#[test]
fn test_chartab_symmetric_c6ph6_d6_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/c6ph6.xyz");
    let thresh = 1e-6;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
    ...
    test_chartab_ordinary_double_group(&mol, thresh, "D6*", &expected_irreps, Some(expected_chars));
}

#[test]
fn test_chartab_symmetric_c6ph6_grey_d6_double() {
    let path: String = format!("{}{}", ROOT, "/tests/xyz/c6ph6.xyz");
    let thresh = 1e-6;
    let mol = Molecule::from_xyz(&path, thresh);
    let expected_irreps = vec![
    ...
    let expected_chars = HashMap::from([
        ...
        (
            (&expected_irreps[13], &tc6),
            Character::new(&[(UnityRoot::new(1, 6), 1), (UnityRoot::new(4, 6), 1)]),
        ),
        (
            (&expected_irreps[14], &tc6),
            Character::new(&[(UnityRoot::new(4, 6), 1), (UnityRoot::new(5, 6), 1)]),
