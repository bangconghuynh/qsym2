...
impl<'a, T, B, SC> Overlap<T, Ix2> for MultiDeterminant<'a, T, B, SC>
where
    T: Lapack
...
pub struct MultiDeterminantSymmetryOrbit<'a, 'g, G, T, B, SC>
where
    ...
    MultiDeterminant<'a, T, B, SC>: SymmetryTransformable,
{
    ...
    origin: &'a MultiDeterminant<'a, T, B, SC>,
...
impl<'a, 'g, G, T, B, SC> MultiDeterminantSymmetryOrbit<'a, 'g, G, T, B, SC>
where
...
impl<'a, 'g, G, T, B, SC> MultiDeterminantSymmetryOrbit<'a, 'g, G, Complex<T>, B, SC>
where
    G: SymmetryGroupProperties,
...
impl<'a, 'g, G, T, B, SC> Orbit<G, MultiDeterminant<'a, T, B, SC>>
    for MultiDeterminantSymmetryOrbit<'a, 'g, G, T, B, SC>
where
    G: SymmetryGroupProperties,
    T: ComplexFloat + fmt::Debug + Lapack,
    SC: StructureConstraint + Hash + Eq + fmt::Display,
    ...
    MultiDeterminant<'a, T, B, SC>: SymmetryTransformable,
{
    ...
    fn origin(&self) -> &MultiDeterminant<'a, T, B, SC> {
        self.origin
    }
...
impl<'a, 'g, G, T, B, SC> RepAnalysis<G, MultiDeterminant<'a, T, B, SC>, T, Ix2>
    for MultiDeterminantSymmetryOrbit<'a, 'g, G, T, B, SC>
where
    G: SymmetryGroupProperties,
