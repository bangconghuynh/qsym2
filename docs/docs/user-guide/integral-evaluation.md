...
=== "Python"
    ```py
    from qsym2 import PyBasisShellContraction, ShellType
    ...
    basis_set = [ #(1)!
        ...
        [ #(2)!
            PyBasisShellContraction( #(3)!
                basis_shell=(0, ShellType.Cartesian, None), #(4)!
                primitives=[ #(5)!
            ...
            PyBasisShellContraction(
                basis_shell=(0, ShellType.Cartesian, None),
                primitives=[
        ...
        [
            ...
            PyBasisShellContraction(
                basis_shell=(1, ShellType.Cartesian, None), #(8)!
                primitives=[
            ...
            PyBasisShellContraction(
                basis_shell=(1, ShellType.Cartesian, [(0, 0, 1), (0, 1, 0), (1, 0, 0)]), #(9)!
                primitives=[
                    (0.1958570000e+00, 1.0000000000e+00),
                ],
                cart_origin=[0.0, 0.0, 1.0],
        ...
        [
            ...
            PyBasisShellContraction(
                basis_shell=(1, ShellType.Pure, True), #(10)!
                primitives=[
            ...
            PyBasisShellContraction(
                basis_shell=(1, ShellType.Pure, [0, +1, -1]), #(11)!
                primitives=[
                    (0.2832050000e+00, 1.0000000000e+00),
                ],
                cart_origin=[0.0, 0.0, 1.5],
    ...
    </br></br>:fontawesome-solid-laptop-code: This class, [`PyBasisShellContraction`](../python/basis.md/#qsym2.PyBasisShellContraction), is a Python-exposed Rust structure to marshall basis shell contraction information between Rust and Python.
    Also refer to the [Rust API documentation](https://qsym2.dev/api/qsym2/bindings/python/integrals/struct.PyBasisShellContraction.html) for this class for more information.
    4. :fontawesome-solid-users: The `basis_shell` parameter is a tuple specifying the angular momentum information of this shell and has the form `(angmom, shelltype, order)` where:
        ...
        * `order` specifies how the functions in the shell are ordered:
        ...
        </li>:fontawesome-solid-laptop-code: Under the hood, this is handled by [`PyShellOrder`](../python/basis.md/#qsym2.PyShellOrder) which is a Python-exposed enumerated type to manage shell order information.
        See also the [Rust API documentation](https://qsym2.dev/api/qsym2/bindings/python/integrals/enum.PyShellOrder.html) for more information.
...
=== "Python"
    ...
    1. :fontawesome-solid-laptop-code: These are Python-exposed functions to evaluate overlap integrals.
    The Python API documentation for these functions can be found [here](../python/integral-evaluation.md).
    The Rust API documentation for these functions can be found [here](https://qsym2.dev/api/qsym2/bindings/python/integrals/index.html).
