...
=== "Python"
    ...
    6. :fontawesome-solid-users: [`PyVibrationalCoordinateCollectionReal`](../../python/representation-analysis/vibrational-coordinates.md/#qsym2.PyVibrationalCoordinateCollectionReal) constructs a *real-valued* object containing multiple vibrational modes. If *complex-valued* vibrational modes are required instead, use [`PyVibrationalCoordinateCollectionComplex`](../../python/representation-analysis/vibrational-coordinates.md/#qsym2.PyVibrationalCoordinateCollectionComplex).
    ...
    </br></br>:fontawesome-solid-laptop-code: This is a Python-exposed Rust function, [`rep_analyse_vibrational_coordinate_collection`](../../python/representation-analysis/vibrational-coordinates.md/#qsym2.rep_analyse_vibrational_coordinate_collection). See the API documentation of this function for more details.
